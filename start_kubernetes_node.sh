...
sudo docker -H unix:///var/run/docker-bootstrap.sock exec  2e1cb1f835f5bc4a37b23638762d5b2c96a85418c2915627cdf0ef5cdf527535 cat /run/flannel/subnet.env

echo "


DOCKER_OPTS=\"--bip=${FLANNEL_SUBNET} --mtu=${FLANNEL_MTU}\"" > /etc/default/docker
